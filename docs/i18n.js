...
const I18N = {
  ko: {
    ...
    guides: {
      ...
      경고: [
        ...
        "시원한 물을 천천히 마시세요.",
        "증상이 나아지지 않으면 관리자에게 알리거나 아래 전화버튼을 눌러 연락하세요."
      ],
      위험: [
  ...
  ru: {
    ...
    level_위험: "Опасность",
    hotlineLabel: "Запросить помощь",
    hotlineSmsLabel: "Отправить SMS о помощи",
    backBtn: "На главную",
    guides: {
      ...
      경고: [
        ...
        "Если симптомы не проходят, сообщите руководителю или нажмите кнопку звонка ниже."
      ],
      위험: [
  ...
  mn: {
    ...
    level_위험: "Аюултай",
    hotlineLabel: "Тусламж хүсэх",
    hotlineSmsLabel: "Яаралтай тусламжийн SMS илгээх",
    backBtn: "Эхлэл рүү",
    guides: {
      ...
      경고: [
        ...
        "Шинж тэмдэг сайжрахгүй бол менежерт мэдэгдэх эсвэл доорх залгах товчийг дарна уу."
      ],
      위험: [
